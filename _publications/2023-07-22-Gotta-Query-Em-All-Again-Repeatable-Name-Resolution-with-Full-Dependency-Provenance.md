...
---
[<i class="ai ai-google-scholar"></i>](https://scholar.google.com/scholar?q=Gotta+Query+&#x27;Em+All,+Again!+Repeatable+Name+Resolution+with+Full+Dependency+Provenance){: .btn--research-inverse} [Bib](/bibentries/naab2023querythemall.bib){: .btn--research-inverse} [<i class="fas fa-file-pdf"></i>](/files/naab2023querythemall.pdf){: .btn--research-inverse} [Homepage](https://tcb-resolve.github.io/){: .btn--research}