...
---
[<i class="ai ai-google-scholar"></i>](https://scholar.google.com/scholar?q=TTL+Jumps:+Unexpected+TTL+Rewrites+Impacting+Inferences+from+Traceroutes){: .btn--research-inverse} [<i class="fas fa-file-pdf"></i>](/files/kappes2026ttlrewrites.pdf){: .btn--research-inverse}